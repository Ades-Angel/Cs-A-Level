...
cactus_img = pygame.image.load(r'C:\Users\Student\Desktop\mario game\cactus_bricks.png')
cactus_img_rect = cactus_img.get_rect()
cactus_img_rect.left = 0

fire_img = pygame.image.load(r'C:\Users\Student\Desktop\mario game\fire_bricks.png')
...
class Dragon:
    ...
    def __init__(self):
        self.dragon_img = pygame.image.load(r'C:\Users\Student\Desktop\mario game\dragon.png')
...
class Flames:
    ...
    def __init__(self):
        self.flames = pygame.image.load(r'C:\Users\Student\Desktop\mario game\fireball.png')
...
class Mario:
    ...
    def __init__(self):
        self.mario_img = pygame.image.load(r'C:\Users\Student\Desktop\mario game\mario.png')
...
def game_over():
    ...
    music = pygame.mixer.Sound(r'C:\Users\Student\Desktop\mario game\mario_dies.wav')
    music.play()
    topscore.top_score(score)
    game_over_img = pygame.image.load(r'C:\Users\Student\Desktop\mario game\end.png')
...
def start_game():
    canvas.fill(black)
    start_img = pygame.image.load(r'C:\Users\Student\Desktop\mario game\start.png')
...
def game_loop():
    while True:
        ...
        score = 0
        flames_list = []
        pygame.mixer.music.load(r'C:\Users\Student\Desktop\mario game\mario_theme.wav')
